...
namespace telcodatagen
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Did not find Eventhub name or connections string in appsettings (App.config)");
                return;
            }
        ...
        // Generate data
        static void GenerateData(EventHubProducerClient producer, string[] args)
        {
